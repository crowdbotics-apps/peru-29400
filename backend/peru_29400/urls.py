...
admin.site.site_header = "Peru"
admin.site.site_title = "Peru Admin Portal"
admin.site.index_title = "Peru Admin"

# swagger
api_info = openapi.Info(
    title="Peru API",
    default_version="v1",
    description="API documentation for Peru App",
)
